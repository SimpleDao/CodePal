...
| 项目 | 值 |
|------|----|
| Endpoint | `GET https://app-btebw5qkzr41-api-wLNdo2j5eQWa-gateway.appmiaoda.com/v2/baike/lemma/get_content` |
...
async function getBaikeLemma(searchType: "lemmaTitle" | "lemmaId", searchKey: string) {
  ...
  const response = await fetch(
    `https://app-btebw5qkzr41-api-wLNdo2j5eQWa-gateway.appmiaoda.com/v2/baike/lemma/get_content?${params}`,
    {
      method: "GET",
      headers: {
