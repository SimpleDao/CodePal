...
async function createTTSTask(
  ...
  const response = await fetch(
    "https://app-btebw5qkzr41-api-nYWNozBb8X3L-gateway.appmiaoda.com/rpc/2.0/tts/v1/create",
    {
      method: "POST",
      headers: {
...
async function queryTTSTask(taskId: string): Promise<{
  ...
  const response = await fetch(
    "https://app-btebw5qkzr41-api-Q9KWZ2jy8W09-gateway.appmiaoda.com/rpc/2.0/tts/v1/query",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
