...
| 第三方域名 | `app-btebw5qkzr41-api-V9gDzg15D7BL-gateway.appmiaoda.com` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-btebw5qkzr41-api-V9gDzg15D7BL-gateway.appmiaoda.com/v1/video_generation",
    {
      method: "POST",
      headers: {
...
async function queryTextToVideo(taskId: string): Promise<{
  ...
  const url = new URL("https://app-btebw5qkzr41-api-zYkZz2eDWvPL-gateway.appmiaoda.com/v1/query/video_generation");
...
async function retrieveVideoFile(fileId: string): Promise<{
  ...
  const url = new URL("https://app-btebw5qkzr41-api-GYX1ld3ExkQa-gateway.appmiaoda.com/v1/files/retrieve");
