...
| 项目 | 值 |
|------|----|
| Endpoint | `POST https://app-btebw5qkzr41-api-DLEO7Bj0lORa-gateway.appmiaoda.com/v1/t2a_v2` |
...
async function callMinimaxTTS(
  ...
  const response = await fetch("https://app-btebw5qkzr41-api-DLEO7Bj0lORa-gateway.appmiaoda.com/v1/t2a_v2", {
    method: "POST",
    headers: {
