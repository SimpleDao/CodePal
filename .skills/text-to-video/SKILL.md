...
| 第三方域名 | `app-btebw5qkzr41-api-o9wN672BkyMa-gateway.appmiaoda.com` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-btebw5qkzr41-api-o9wN672BkyMa-gateway.appmiaoda.com/beta/video/generations/kling/text2video",
    {
      method: "POST",
      headers: {
...
async function queryTextToVideo(taskId: string): Promise<{
  ...
  const url = new URL(
    "https://app-btebw5qkzr41-api-nYWNozBb5qML-gateway.appmiaoda.com/beta/video/generations/kling/text2video"
  );
