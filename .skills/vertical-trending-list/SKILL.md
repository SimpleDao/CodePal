...
- **Endpoint**：`POST https://app-btebw5qkzr41-api-ra5EZDjVyjVa-gateway.appmiaoda.com/v2/tools/trending_lists/vertical`
...
const response = await fetch(
  "https://app-btebw5qkzr41-api-ra5EZDjVyjVa-gateway.appmiaoda.com/v2/tools/trending_lists/vertical",
  {
    method: "POST",
    headers: {
