 ...
 * @date 2026-05-24
 */
public class CPBlockRenderer implements EditorCustomElementRenderer {

    /** 后续各行文本（不含第一行，第一行由 CPInlayRenderer 显示） */
    private volatile String[] lines;
    private final Editor   editor;

    public CPBlockRenderer(@NotNull String[] lines, @NotNull Editor editor) {
        this.lines  = lines;
        this.editor = editor;
    }
