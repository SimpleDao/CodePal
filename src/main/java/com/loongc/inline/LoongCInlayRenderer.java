 ...
 * @date 2026-05-24
 */
public class LoongCInlayRenderer implements EditorCustomElementRenderer {

    /** 本行要显示的文本（仅第一行内容，后续行由 LoongCBlockRenderer 负责） */
    private volatile String text;
    private final Editor editor;

    public LoongCInlayRenderer(@NotNull String text, @NotNull Editor editor) {
        this.text   = text;
        this.editor = editor;
    }
